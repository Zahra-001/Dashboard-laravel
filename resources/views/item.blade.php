...
<div class="container">
        <h5 class="alert alert-secondary text-center fw-semibold" style='border: none; color: white; background-color: #E6A4B4;'>All Items Section</h5>
        <div class="row text-center mt-3 d-flex align-items-center justify-content-center">
            ...
            <div class="card" id='items' style="width: 22rem; height: 18rem;">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col">
                            <a href="{{ route('addtocartitem', ['id'=>$row->id]) }}" id='add' class="btn btn-secondary mt-2">Add to cart</a>
                        </div>
                    </div>
                </div>
            </div>
